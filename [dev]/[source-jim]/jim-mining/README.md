...
- Customisable points for mining, stone cracking and gold panning
  - Add a Location for an ore to the config and it will use this location for both et-target and a prop
...
## Dependencies
- et-menu - for the menus
- et-target - for the third eye selection
