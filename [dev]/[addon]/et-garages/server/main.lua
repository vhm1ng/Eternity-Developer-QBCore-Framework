...
QBCore.Functions.CreateCallback("et-garage:server:GetOutsideVehicle", function(source, cb, plate)
    local src = source
...
QBCore.Functions.CreateCallback("et-garages:server:GetVehicleLocation", function(source, cb, plate)
    local src = source
...
QBCore.Functions.CreateCallback("et-garage:server:CheckSpawnedVehicle", function(source, cb, plate)
    cb(VehicleSpawnerVehicles[plate] ~= nil and VehicleSpawnerVehicles[plate])
end)

RegisterNetEvent("et-garage:server:UpdateSpawnedVehicle", function(plate, value)
    VehicleSpawnerVehicles[plate] = value
end)

QBCore.Functions.CreateCallback('et-garage:server:spawnvehicle', function (source, cb, vehInfo, coords, warp)
...
QBCore.Functions.CreateCallback("et-garage:server:GetGarageVehicles", function(source, cb, garage, garageType, category)
    local src = source
    local pData = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateCallback("et-garage:server:checkOwnership", function(source, cb, plate, garageType, garage, gang)
    local src = source
    local pData = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateCallback("et-garage:server:GetVehicleProperties", function(source, cb, plate)
    local properties = {}
    local result = MySQL.query.await('SELECT mods FROM player_vehicles WHERE plate = ?', {plate})
    if result[1] then
...
RegisterNetEvent('et-garage:server:updateVehicle', function(state, fuel, engine, body, properties, plate, garage, location, damage)
...
RegisterNetEvent('et-garage:server:updateVehicleState', function(state, plate, garage)
    MySQL.update('UPDATE player_vehicles SET state = ?, garage = ?, depotprice = ? WHERE plate = ?',{state, garage, 0, plate})
end)

RegisterNetEvent('et-garages:server:UpdateOutsideVehicles', function(Vehicles)
    local src = source
...
QBCore.Functions.CreateCallback("et-garage:server:GetOutsideVehicles", function(source, cb)
...
RegisterNetEvent('et-garage:server:PayDepotPrice', function(data)
    local src = source
...
RegisterNetEvent('et-garages:server:parkVehicle', function(plate)
...
--External Calls
--Call from et-vehiclesales
QBCore.Functions.CreateCallback("et-garage:server:checkVehicleOwner", function(source, cb, plate)
    local src = source
    local pData = QBCore.Functions.GetPlayer(src)
...
--Call from et-phone
QBCore.Functions.CreateCallback('et-garage:server:GetPlayerVehicles', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    local Vehicles = {}
...
if Config.EnableTrackVehicleByPlateCommand then
    ...
    TriggerClientEvent('et-garages:client:TrackVehicleByPlate', source, args[1])
