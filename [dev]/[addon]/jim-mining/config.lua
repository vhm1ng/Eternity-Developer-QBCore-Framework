...
Config = {
	...
	img = "et-inventory/html/images/", --Set this to the image directory of your inventory script or "nil" if using newer et-menu
	CheckMarks = true, -- shows checkmarks if user has the materials to craft an item, set false if causing lag.
	Lan = "en", -- Pick your language here
	JimMenu = true, -- Set this to true if using update et-menu with icons
...
--Mining Store Items
	Items = {
		...
		items = {
			{ name = "khong1", price = 999999999, amount = 1, info = {}, type = "item", slot = 1, },
			{ name = "khong2", price = 999999999, amount = 1, info = {}, type = "item", slot = 2, },
			{ name = "khong3", price = 999999999, amount = 1, info = {}, type = "item", slot = 3, },
			{ name = "khong4", price = 999999999, amount = 1, info = {}, type = "item", slot = 4, },
			{ name = "khong5", price = 999999999, amount = 1, info = {}, type = "item", slot = 5, },
