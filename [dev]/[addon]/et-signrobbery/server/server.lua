...
QBCore.Functions.CreateCallback("et-signrobbery:server:GetObjects", function(source, cb)
    cb(objects)
end)

RegisterNetEvent('et-signrobbery:server:delete')
AddEventHandler('et-signrobbery:server:delete', function(object)
    local src = source
