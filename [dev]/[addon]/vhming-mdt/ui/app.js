...
$(document).ready(() => {
  ...
  $(".profile-items").on("click", ".profile-item", async function () {
    ...
    $(".manage-profile-editing-title").html(`Bạn hiện đang chỉnh sửa ${result["firstname"]} ${result["lastname"]}`);
      ...
      if (canSaveProfile == true) {
        ...
        setTimeout(() => {
          if (canRefreshIncidents == true) {
            ...
            setTimeout(() => {
              $(".incidents-search-refresh").empty();
              $(".incidents-search-refresh").html("Làm mới");
  ...
  $(".manage-incidents-title-holder").on(
    ...
    function () {
      ...
      $(".manage-incidents-title-holder").prepend(
        `
            <div class="manage-incidents-title">Quản lý vụ án</div>
      ...
      $(".manage-incidents-editing-title").html(
        "Bạn hiện đang tạo một vụ án mới"
      );
  ...
  $(".manage-bolos-title-holder").on(
    ...
    function () {
      ...
      $(".manage-bolos-editing-title").html(
        "Bạn hiện đang tạo một hồ sơ xe gây án mới"
      );
  ...
  $(".bolos-search-refresh").click(function () {
    if (canRefreshBolo == true) {
      ...
      setTimeout(() => {
        $(".bolos-search-refresh").empty();
        $(".bolos-search-refresh").html("Làm mới");
        canRefreshBolo = true;
  ...
  $(".reports-search-refresh").click(function () {
    if (canRefreshReports == true) {
      ...
      setTimeout(() => {
        $(".reports-search-refresh").empty();
        $(".reports-search-refresh").html("Làm mới");
  ...
  $(".dispatch-comms-refresh").click(function () {
    ...
    setTimeout(() => {
      $(".dispatch-comms-refresh").empty();
      $(".dispatch-comms-refresh").html("Làm mới");
      canRefreshReports = true;
  ...
  $(".manage-reports-title-holder").on(
    ...
    function () {
      ...
      $(".manage-reports-editing-title").html(
        "Bạn hiện đang tạo một báo cáo mới"
      );
  ...
  function JobColors(sentJob) {
    if (sentJob) {
      if (PoliceJobs[sentJob] !== undefined) {
        ...
        $(".header-title").html("GOTHAM POLICE");
        $(".bolo-nav-item").html("Xe gây án");
        $(".bolos-search-title").html("Xe gây án");
        $("#bolos-search-input").attr("placeholder", "Tìm xe gây án...");
        $(".manage-bolos-title").html("Quản lý xe gây án");
        $(".manage-bolos-editing-title").html(
          "Bạn hiện đang tạo một hồ sơ xe gây án mới"
        );
        $(".boloplate-title").html("Biển số");
        $(".boloowner-title").html("Chủ sở hữu");
        $(".boloindividual-title").html("Đặc điểm");
        $("#boloplate").attr("placeholder", "Nhập biển số ở đây ...");
        $("#bolodetail").attr(
          "placeholder",
          "Chi tiết ..."
        );
...
{/* <div class="bulletin-id">ID: ${value.id}</div> */}
  window.addEventListener("message", function (event) {
    ...
    /* } else if (eventData.type == "bulletin") {
        ...
        $(".incidents-items").append(
          `<div class="incidents-item" data-id="${value.id}">
                    <div class="incidents-top-holder">
                        ...
                        <div class="incedent-report-name">Báo cáo vụ án</div>
                    </div>
      ...
      $(".manage-incidents-editing-title").html(
        "Bạn hiện đang chỉnh sửa vụ án " + table["id"]
      );
      ...
      let table = eventData.data;
      $(".manage-bolos-editing-title").html(
        "Bạn hiện đang chỉnh sửa xe gây án " + table["id"]
      );
      ...
      $(".manage-bolos-editing-title").html(
        "Bạn hiện đang chỉnh sửa xe gây án " + id
      );
      ...
      $(".manage-reports-editing-title").html(
        "Bạn hiện đang chỉnh sửa báo cáo " + id
      );
      ...
      $(".manage-reports-editing-title").html(
        "Bạn hiện đang chỉnh sửa báo cáo " + table["id"]
      );
