...
Config.IBANChangeCost = 20000 -- How much it costs to change the IBAN to a custom one (on Settings tab)
...
Config.CreditCardPrice = 5000 -- How much it costs to purchase a credit card
