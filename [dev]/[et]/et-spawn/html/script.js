...
function setupApps(apps) {
    ...
    $(parent).append('<div class="loclabel" id="location" data-location="null" data-type="lab" data-label="Chọn một chung cư"><p><span id="null">Lựa chọn chung cư</span></p></div>')
