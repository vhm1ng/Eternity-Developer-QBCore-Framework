...
RegisterServerEvent('et-armoredtruckheist:server:callCops', function(streetLabel, coords)
    TriggerClientEvent("et-armoredtruckheist:client:robberyCall", -1, streetLabel, coords)
end)
