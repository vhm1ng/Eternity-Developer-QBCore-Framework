...
RegisterNetEvent('et-armoredtruckheist:client:911alert', function()
    if PoliceAlert == 0 then
        ...
        TriggerServerEvent("et-armoredtruckheist:server:callCops", streetLabel, transCoords)
...
RegisterNetEvent('et-armoredtruckheist:client:robberyCall', function(streetLabel, coords)
    if PlayerJob.name == "police" then
        local store = "Armored Truck"

        PlaySound(-1, "Lose_1st", "GTAO_FM_Events_Soundset", 0, 0, 1)
        TriggerEvent('et-policealerts:client:AddPoliceAlert', {
            timeOut = 10000,
        ...
        if MissionStart == 1 then
            ...
            if dist <= 7 and BlownUp == 0 and PlayerJob.name ~= 'police' then
                ...
                if IsControlPressed(0, 47) and GuardsDead == 1 then
                    ...
                    TriggerEvent("et-armoredtruckheist:client:911alert")
                    Citizen.Wait(500)
                end
            end
