...
RegisterNetEvent('et-bossmenu:client:OpenMenu', function()
    ...
    local bossMenu = {
        ...
        },
        {
            ...
            params = {
                event = "et-bossmenu:client:employeelist",
            }
        },
        {
            ...
            params = {
                event = "et-bossmenu:client:HireMenu",
            }
        },
        {
            ...
            params = {
                event = "et-bossmenu:client:Stash",
            }
        },
        {
            ...
            params = {
                event = "et-bossmenu:client:Wardrobe",
            }
        },
        {
            ...
            params = {
                event = "et-bossmenu:client:SocietyMenu",
            }
        },
    }
    ...
    exports['et-menu']:openMenu(bossMenu)
end)

RegisterNetEvent('et-bossmenu:client:employeelist', function()
    local EmployeesMenu = {
        {
    ...
    QBCore.Functions.TriggerCallback('et-bossmenu:server:GetEmployees', function(cb)
        for _, v in pairs(cb) do
            EmployeesMenu[#EmployeesMenu + 1] = {
                ...
                params = {
                    event = "et-bossmenu:client:ManageEmployee",
                    args = {
                        player = v,
                        work = PlayerJob
                    }
        ...
        EmployeesMenu[#EmployeesMenu + 1] = {
            ...
            icon = "fa-solid fa-angle-left",
            params = {
                event = "et-bossmenu:client:OpenMenu",
            }
        }
        exports['et-menu']:openMenu(EmployeesMenu)
    end, PlayerJob.name)
end)

RegisterNetEvent('et-bossmenu:client:ManageEmployee', function(data)
    local EmployeeMenu = {
        {
    ...
    for k, v in pairs(QBCore.Shared.Jobs[data.work.name].grades) do
        EmployeeMenu[#EmployeeMenu + 1] = {
            ...
            params = {
                isServer = true,
                event = "et-bossmenu:server:GradeUpdate",
    ...
    EmployeeMenu[#EmployeeMenu + 1] = {
        ...
        params = {
            isServer = true,
            event = "et-bossmenu:server:FireEmployee",
    ...
    exports['et-menu']:openMenu(EmployeeMenu)
end)

RegisterNetEvent('et-bossmenu:client:Stash', function()
...
RegisterNetEvent('et-bossmenu:client:Wardrobe', function()
    TriggerEvent('et-clothing:client:openOutfitMenu')
end)

RegisterNetEvent('et-bossmenu:client:HireMenu', function()
    local HireMenu = {
        {
    ...
    QBCore.Functions.TriggerCallback('et-bossmenu:getplayers', function(players)
        for _, v in pairs(players) do
            if v and v ~= PlayerId() then
                HireMenu[#HireMenu + 1] = {
                    ...
                    params = {
                        isServer = true,
                        event = "et-bossmenu:server:HireEmployee",
                        args = v.sourceplayer
                    }
                }
            end
        ...
        exports['et-menu']:openMenu(HireMenu)
    end)
end)

RegisterNetEvent('et-bossmenu:client:SocietyMenu', function()
    QBCore.Functions.TriggerCallback('et-bossmenu:server:GetAccount', function(cb)
        local SocietyMenu = {
            {
            ...
            },
            {
                ...
                params = {
                    event = "et-bossmenu:client:SocetyDeposit",
                    args = comma_value(cb)
                }
            },
            {
                ...
                params = {
                    event = "et-bossmenu:client:SocetyWithDraw",
                    args = comma_value(cb)
                }
            },
            {
...
RegisterNetEvent('et-bossmenu:client:SocetyDeposit', function(money)
    ...
    if deposit then
        ...
        TriggerServerEvent("et-bossmenu:server:depositMoney", tonumber(deposit.amount))
    end
end)

RegisterNetEvent('et-bossmenu:client:SocetyWithDraw', function(money)
    ...
    if withdraw then
        ...
        TriggerServerEvent("et-bossmenu:server:withdrawMoney", tonumber(withdraw.amount))
    end
end)
    ...
    if Config.UseTarget then
        for job, zones in pairs(Config.BossMenuZones) do
            for index, data in ipairs(zones) do
                exports['et-target']:AddBoxZone(job.."-BossMenu-"..index, data.coords, data.length, data.width, {
                            ...
                            if #(pos - coords) < 5.0 then
                                ...
                                if #(pos - coords) <= 1.5 then
                                    ...
                                    if not shownBossMenu then
                                        exports['et-core']:DrawText(Lang:t("drawtext.label"), 'left')
                                        shownBossMenu = true
                                    end
                                    if IsControlJustReleased(0, 38) then
                                        exports['et-core']:HideText()
                                        TriggerEvent("et-bossmenu:client:OpenMenu")
                                    end
                                end
