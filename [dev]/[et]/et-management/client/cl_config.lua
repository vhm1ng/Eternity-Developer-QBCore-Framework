...
Config.BossMenuZones = {
    ['police'] = {
        { coords = vector3(448.54, -973.31, 30.69), length = 0.35, width = 0.45, heading = 351.0, minZ = 30.58, maxZ = 30.68 } ,
    },
    ['ambulance'] = {
    ...
    ['cardealer'] = {
        { coords = vector3(-339.84, -1357.38, 31.87), length = 2.4, width = 1.05, heading = 89.55, minZ = 31.87, maxZ = 31.87 },
    },
    ['mechanic'] = {
