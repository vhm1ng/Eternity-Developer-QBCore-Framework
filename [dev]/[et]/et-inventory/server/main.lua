	...
	elseif QBCore.Shared.SplitStr(fromInventory, "-")[1] == "itemshop" then
		...
		elseif QBCore.Shared.SplitStr(shopType, "_")[1] == "Itemshop" then
            if Player.Functions.RemoveMoney("cash", price, "itemshop-bought-item") then
                ...
                local imageurl = ("https://cfx-nui-et-inventory/html/images/%s.png"):format(itemData.name)
...
RegisterNetEvent('et-inventory:server:SaveStashItems', function(stashId, items)
...
QBCore.Functions.CreateCallback('et-inventory:server:GetStashItems', function(source, cb, stashId)
...
QBCore.Commands.Add("giveitem", "Give An Item (Admin Only)", {{name="id", help="Player ID"},{name="item", help="Name of the item (not a label)"}, {name="amount", help="Amount of items"}}, false, function(source, args)
	...
	local cardlist = {"id_card", "driver_license", "weaponlicense", "lawyerpass", "copbadge"}
	...
	if Player then
			if itemData then
                ...
                if string.find(table.concat(cardlist, ","), itemData["name"]) then
                    exports['vhming-idcard']:CreateMetaLicense(id, itemData["name"])
				...
				elseif itemData["name"] == "goldpan" then
					info.uses = 100
				elseif itemData["name"] == "xosua" then
					info.uses = 100
