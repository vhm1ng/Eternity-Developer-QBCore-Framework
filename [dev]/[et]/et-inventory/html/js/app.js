...
function showBlur() {
    $.post('https://et-inventory/showBlur');
}
...
function changeInventoryColor(color) {
    ...
    localStorage.setItem('et-inventory-color', color);
}

const savedColor = localStorage.getItem('et-inventory-color');
...
function FormatAttachmentInfo(data) {
    $.post(
        "https://et-inventory/GetWeaponData",
        JSON.stringify({
            weapon: data.name,
...
function handleAttachmentDrag() {
    ...
    $(".weapon-attachments-remove").droppable({
        ...
        drop: function(event, ui) {
            $.post(
                "https://et-inventory/RemoveAttachment",
                JSON.stringify({
...
$(document).on("click", ".CombineItem", function(e) {
    ...
    if (combineslotData.toData.combinable.anim != null) {
        $.post(
            "https://et-inventory/combineWithAnim",
            JSON.stringify({
        ...
        $.post(
            "https://et-inventory/combineItem",
            JSON.stringify({
...
function optionSwitch(
    ...
    $.post(
        "https://et-inventory/SetInventoryData",
        JSON.stringify({
...
function swap($fromSlot, $toSlot, $fromInv, $toInv, $toAmount) {
    ...
    if (fromData !== undefined && fromData.amount >= $toAmount) {
        ...
        if (
            ...
            $.post("https://et-inventory/PlayDropSound", JSON.stringify({}));
            $.post(
                "https://et-inventory/SetInventoryData",
                JSON.stringify({
                    fromInventory: $fromInv.attr("data-inventory"),
            ...
            if (fromData.amount == $toAmount) {
                if (
                    ...
                    $.post(
                        "https://et-inventory/getCombineItem",
...
function InventoryError($elinv, $elslot) {
    ...
    $.post("https://et-inventory/PlayDropFail", JSON.stringify({}));
}
...
(() => {
    ...
    Inventory.Close = function() {
        ...
        $.post("https://et-inventory/CloseInventory", JSON.stringify({}));
