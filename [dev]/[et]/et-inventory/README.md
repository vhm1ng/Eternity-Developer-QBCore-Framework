...
* [et-logs](https://github.com/qbcore-framework/et-logs)
* [et-traphouse](https://github.com/qbcore-framework/et-traphouse)
* [et-radio](https://github.com/qbcore-framework/et-radio)
* [et-drugs](https://github.com/qbcore-framework/et-drugs)
* [et-shops](https://github.com/qbcore-framework/et-shops)

# How to install et-inventory (Latest QBCore Update)
* Download source files from github
* Make sure you have latest updated [et-core](https://github.com/qbcore-framework/et-core)
* Make sure you have latest updated [et-smallresources](https://github.com/qbcore-framework/et-smallresources)
* Make sure you have latest updated [et-weapons](https://github.com/qbcore-framework/et-weapons)
* Drag source files into your resources folder
* Rename folder from `et-inventory-main` to `et-inventory`
* Replace all et-inventory to et-inventory. Example below using Visual Studio Code in replacing all instances. 
![image](https://user-images.githubusercontent.com/82112471/225484545-b2c79869-e7b4-4f37-81da-829e4430f73f.png)
 

# Key Features
* ALL IMAGES FOLLOW THE SAME DIMENSIONS
* Easy Photoshop guideline template for creating custom images within et-inventory
...
# Previews
### Simple guideline psd provided (found in main directory et-inventory)
![et-inventory Guideline](https://user-images.githubusercontent.com/91661118/146315681-c67f542d-e2bc-43ca-9957-7f1971b84268.png)
### Full Inventory
