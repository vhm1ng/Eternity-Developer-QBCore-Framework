...
RegisterNUICallback('showBlur', function()
    Wait(50)
    TriggerEvent("et-inventory:client:showBlur")
end) 
RegisterNetEvent("et-inventory:client:showBlur", function()
    Wait(50)
...
RegisterNetEvent('inventory:client:OpenInventory', function(PlayerAmmo, inventory, other)
    if not IsEntityDead(PlayerPedId()) then
        if Config.Progressbar.Enable then
            QBCore.Functions.Progressbar('open_inventory', 'Mở kho đồ...', math.random(Config.Progressbar.minT, Config.Progressbar.maxT), false, true, { -- Name | Label | Time | useWhileDead | canCancel
...
RegisterNetEvent('inventory:client:PickupSnowballs', function()
    ...
    QBCore.Functions.Progressbar("pickupsnowball", "Thu thập quả cầu tuyết..", 1500, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
...
CreateThread(function()
    ...
    exports['et-target']:AddTargetModel(toolBoxModels, {
            options = {
                {
