...
CreateThread(function()
    while true do
        ...
        if NetCheck1 or NetCheck2 then
            TriggerServerEvent('et-admin:server:GetPlayersForBlips')
        end
    end
end)

RegisterNetEvent('et-admin:client:toggleBlips', function()
...
RegisterNetEvent('et-admin:client:toggleNames', function()
...
RegisterNetEvent('et-admin:client:Show', function(players)
