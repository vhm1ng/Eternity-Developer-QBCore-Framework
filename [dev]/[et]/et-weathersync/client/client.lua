...
RegisterNetEvent('QBCore:Client:OnPlayerLoaded', function()
    disable = false
    TriggerServerEvent('et-weathersync:server:RequestStateSync')
end)

RegisterNetEvent('et-weathersync:client:EnableSync', function()
    disable = false
    TriggerServerEvent('et-weathersync:server:RequestStateSync')
end)

RegisterNetEvent('et-weathersync:client:DisableSync', function()
	disable = true
...
RegisterNetEvent('et-weathersync:client:SyncWeather', function(NewWeather, newblackout)
    CurrentWeather = NewWeather
    blackout = newblackout
end)

RegisterNetEvent('et-weathersync:client:SyncTime', function(base, offset, freeze)
    freezeTime = freeze
    timeOffset = offset
    baseTime = base
end)
