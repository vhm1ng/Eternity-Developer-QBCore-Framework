![Project Sloth GitHub Project et-fuel Banner](https://user-images.githubusercontent.com/91661118/169398756-5c1a49b8-e21c-4a06-baa6-7fcc793c34e3.png)
...
### Step 1:
Go ahead and start by dragging and dropping et-fuel into your designated resources folder.
...
### Step 2:
Open your entire resources folder with Visual Studio Code (or whichever program you use) and replace all exsiting exports titled "et-fuel" with "et-fuel" instead. 

**If you have the previous resource "lj-fuel" do the same thing and replace that with "et-fuel" or just get this newer version to avoid any conflictions or confusion.**

![explorer_vpSwery89h](https://user-images.githubusercontent.com/91661118/169423238-99659010-718d-4d95-a73e-8aa2b232ebb4.gif)

### Step 3: 
First copy the snippet below and then navigate to your **et-smallresources/client/ignore.lua**
...
Copy this line and then navigate to your **et-inventory/client/main.lua** paste this in your Visual Studio Code search bar.
...
Copy this line and then navigate to your **et-weapons/client/main.lua** paste this in your Visual Studio Code search bar.
...
#### Some features to mention within this et-fuel:
...
Here's a few showcased examples while using et-fuel.
