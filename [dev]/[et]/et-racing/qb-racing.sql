...
-- OPTION 1
-- Use these queries on your database if you are converting your existing et-lapraces table to et-racing
...
-- OPTION 2
-- Use this if you have not used et-lapraces and dont have races to convert
