...
local speed_ud = 3.0 -- speed by wh	ich the camera pans up-down
local toggle_helicam = 26 -- control id of the button by which to toggle the helicam mode. Default: INPUT_CONTEXT (E)
