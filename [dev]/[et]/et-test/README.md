...
## Number Maze
```
exports['et-ui']:Maze(function(success)
    if success then
        print("success")
	else
		print("fail")
...
## VAR
```
exports['et-ui']:VarHack(function(success)
    if success then
        print("success")
	else
		print("fail")
 ...
 ## Thermite
 ```
exports['et-ui']:Thermite(function(success)
    if success then
        print("success")
	else
		print("fail")
...
## Display Text
```
exports['et-ui']:DisplayText("Example Text", "primary") -- Colors: primary, error, success, warning, info, mint
exports['et-ui']:HideText()
```
![image](https://user-images.githubusercontent.com/7463741/170587380-0629b5fc-80d6-4c2a-85c1-4e5426167197.png)

## Status UI
```
exports['et-ui']:StatusShow("Area Dominance", {
  "Gang: Ballas",
  "Influence: %100",
})
exports['et-ui']:StatusUpdate("Area Dominance", {
  "Gang: Ballas",
  "Influence: %99",
})
exports['et-ui']:StatusHide()
```
![image](https://user-images.githubusercontent.com/7463741/170587637-57217095-29ab-460e-9933-123fb0500e12.png)

## Menus
```
exports['et-ui']:CreateMenu({
        {
            header = "header1",
            text = "text1",
...
```
local input = exports['et-ui']:Input({
        title = "Test",
        inputs = {
            {
                type = "text",
...
```
exports['et-ui']:ShowImage("https://user-images.githubusercontent.com/91661118/168956591-43462c40-e7c2-41af-8282-b2d9b6716771.png")
```
