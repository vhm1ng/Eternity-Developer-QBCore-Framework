...
local function loadHouseData()
    ...
    TriggerClientEvent("et-houses:client:setHouseConfig", -1, Houses)
end
...
QBCore.Functions.CreateCallback('et-multi:server:GetCurrentPlayers', function(source, cb)
...
QBCore.Functions.CreateCallback("et-multicharacter:server:GetServerLogs", function(source, cb)
