...
RegisterNetEvent('QBCore:Command:SpawnVehicle', function(vehName)
    ...
    TriggerEvent("vehiclekeys:client:SetOwner2", QBCore.Functions.GetPlate(vehicle))
end)
...
RegisterNetEvent('QBCore:Client:VehicleInfo', function(info)
    ...
    local data = {
        ...
        haskeys = exports['et-vehiclekeys']:HasKeys(plate)
    }
...
RegisterNetEvent('QBCore:Client:UseItem', function(item)
    QBCore.Debug(string.format("%s triggered QBCore:Client:UseItem by ID %s with the following data. This event is deprecated due to exploitation, and will be removed soon. Check et-inventory for the right use on this event.", GetInvokingResource(), GetPlayerServerId(PlayerId())))
    QBCore.Debug(item)
end)
