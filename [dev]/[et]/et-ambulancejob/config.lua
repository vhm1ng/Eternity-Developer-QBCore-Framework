Config = {}
Config.UseTarget = GetConvar('UseTarget', 'false') == 'true' -- Use et-target interactions (don't change this, go to your server.cfg and add setr UseTarget true)
...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ...
    ["beds"] = {
        [1] = {coords = vector4(322.77, -587.05, 44.2, 337.43), taken = false, model = 1631638868},
        [2] = {coords = vector4(317.76, -585.35, 44.2, 337.43), taken = false, model = 1631638868},
        [3] = {coords = vector4(314.57, -584.09, 44.2, 337.43), taken = false, model = 1631638868},
        [4] = {coords = vector4(311.16, -582.95, 44.2, 337.43), taken = false, model = 1631638868},
        [5] = {coords = vector4(307.8, -581.75, 44.2, 337.43), taken = false, model = 1631638868},
    -- giuong sau
        [6] = {coords = vector4(309.2, -577.33, 44.2, 155.66), taken = false, model = 1631638868},
        [7] = {coords = vector4(313.8, -579.06, 44.2, 155.66), taken = false, model = 1631638868},
        [8] = {coords = vector4(319.32, -580.92, 44.2, 155.66), taken = false, model = 1631638868},
        [9] = {coords = vector4(324.17, -582.8, 44.2, 160.11), taken = false, model = 1631638868},
	--- paleto
    ...
    ["jailbeds"] = {
        [1] = {coords = vector4(1761.96, 2597.74, 45.66, 270.14), taken = false, model = 1631638868},
        [2] = {coords = vector4(1761.96, 2591.51, 45.66, 269.8), taken = false, model = 1631638868},
        [3] = {coords = vector4(1771.8, 2598.02, 45.66, 89.05), taken = false, model = 1631638868},
        [4] = {coords = vector4(1771.85, 2591.85, 45.66, 91.51), taken = false, model = 1631638868},
    },
    ["stations"] = {
