...
RegisterNetEvent('et-fitbit:use', function()
    openWatch()
end)
...
RegisterNUICallback('setFoodWarning', function(data, cb)
    ...
    TriggerServerEvent('et-fitbit:server:setValue', 'food', foodValue)
...
RegisterNUICallback('setThirstWarning', function(data, cb)
    ...
    TriggerServerEvent('et-fitbit:server:setValue', 'thirst', thirstValue)
