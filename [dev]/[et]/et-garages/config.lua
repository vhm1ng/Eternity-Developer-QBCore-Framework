...
Config.FuelScript = 'tC-fuel' -- change to lj-fuel / ps-fuel if you use lj-fuel / ps-fuel or something else if you use any other LegcyFuel compatible script
...
Config.Garages = {
    ...
    ['police'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
            vector2(536.02868652344, 6.5830941200256),
            vector2(544.72161865234, -16.049825668335),
            vector2(551.39361572266, -13.699313163757),
            vector2(554.89855957031, -22.28600692749),
            vector2(553.75701904297, -28.563503265381),
            vector2(594.71752929688, -35.686496734619),
            vector2(595.75305175781, -29.615558624268),
            vector2(598.47222900391, -8.5231895446777),
            vector2(596.21020507812, -0.6420191526413),
            vector2(597.52258300781, 6.5531902313232),
            vector2(556.22406005859, 13.913439750671)
            },
