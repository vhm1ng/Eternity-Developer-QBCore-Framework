...
RegisterCommand("qbmenutest", function(source, args, raw)
    openMenu({
        ...
        },
        {
            ...
            params = {
                event = "et-menu:client:testMenu2",
                args = {
                    number = 1,
                }
            }
...
```
```
RegisterNetEvent('et-menu:client:testMenu2', function(data)
    ...
    openMenu({
        ...
        },
        {
            ...
            txt = "Other",
            params = {
                event = "et-menu:client:testButton",
                args = {
...
```
```
RegisterNetEvent('et-menu:client:testButton', function(data)
