...
RegisterNetEvent('et-menu:client:openMenu', function(data)
    openMenu(data)
end)

RegisterNetEvent('et-menu:client:closeMenu', function()
    closeMenu()
end)
...
RegisterNUICallback('closeMenu', function(_, cb)
    ...
    SetNuiFocus(false)
    cb('ok')
    TriggerEvent("et-menu:client:menuClosed")
end)
