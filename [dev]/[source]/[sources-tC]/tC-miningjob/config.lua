...
Config = {
	...
	img = "et-inventory/html/images/", --Set this to the image directory of your inventory script or "nil" if using newer tC-menu
	CheckMarks = true, -- shows checkmarks if user has the materials to craft an item, set false if causing lag.
	Lan = "en", -- Pick your language here
	JimMenu = false, -- Set this to true if using update tC-menu with icons
	...
	Locations =  {
		['MineStore'] = {
			{ name = "~g~[CÔNG VIỆC] ~w~ĐÀO ĐÁ", coords = vector4(2960.9, 2754.14, 43.71, 204.58), sprite = 527, col = 81, blipTrue = true, model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD",  },
		},
		['Smelter'] = {	 -- The location of the smelter
			{ name = "~g~[CÔNG VIỆC] ~w~NUNG ĐÁ", coords = vector3(1112.29, -2009.9, 31.46), sprite = 436, col = 1, blipTrue = true, },
		},
		["Washing"] = {
			{ name = "~g~[CÔNG VIỆC] ~w~RỬA ĐÁ", coords = vector3(1840.18, 412.42, 160.49), sprite = 467, col = 3, disp = 6, blipTrue = true }, -- Mountains
			{ name = "~g~[CÔNG VIỆC] ~w~RỬA ĐÁ", coords = vector3(1870.91, 395.1, 160.16), sprite = 467, col = 3, disp = 6, blipTrue = false },
		},
		["Panning"] = {
			{ name = "~g~[CÔNG VIỆC] ~w~ĐÃI VÀNG", coords = vector3(-1656.67, 2074.85, 87.37), sprite = 467, col = 5, disp = 6, blipTrue = true }, -- Vineyard
			{ name = "~g~[CÔNG VIỆC] ~w~ĐÃI VÀNG", coords = vector3(-1672.06, 2070.89, 91.68), sprite = 467, col = 5, blipTrue = false },
		},
		['Cracking'] = { -- The location of the smelter
		},
		['OreBuyer'] = { -- The Locations of the ore buyers
			{ name = "~g~[CÔNG VIỆC] ~w~THU MUA VẬT LIỆU", coords = vector4(453.06, -767.6, 27.36, 269.27), sprite = 568, col = 81, blipTrue = false, model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD", },
		},
		['JewelCut'] = { -- The Location of the jewel cutting bench. Couldn't decide so left in smeltery
			{ name = "~g~[CÔNG VIỆC] ~w~CẮT ĐÁ QUÝ", coords = vector4(1077.11, -1984.22, 31.02, 235.8), sprite = 566, col = 81, blipTrue = false, prop = `gr_prop_gr_speeddrill_01c` },
		},
		['JewelBuyer'] = { -- The Location of the jewel buyer, I left this as Vangelico, others will proabably change to pawn shops
			{ name = "~g~[CÔNG VIỆC] ~w~THU MUA ĐÁ QUÝ", coords = vector4(453.16, -770.0, 27.36, 273.65), sprite = 527, col = 617, blipTrue = false, model = `S_M_M_HighSec_03`, scenario = "WORLD_HUMAN_CLIPBOARD", },
		},
	},
