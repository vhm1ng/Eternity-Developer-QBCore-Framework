 ...
 **/
const setVisibility = (visibility) => getElementById('tC-idcard').style.visibility = visibility;
...
const closeFunction = () => {
  getElementById('tC-idcard').classList.remove('animate__animated', 'animate__fadeInLeft', 'animate__faster');
...
const openIdCard = (playerData) => {
  ...
  getElementById('tC-idcard').style.backgroundColor = license.background;
  getElementById('tC-idcard').classList.add('animate__animated', 'animate__fadeInLeft', 'animate__faster');
