...
local vehHeaderMenu = {
    {
        ...
        params = {
            event = 'tC-vehicleshop:client:showVehOptions'
        }
    }
}
...
local returnTestDrive = {
    {
        ...
        params = {
            event = 'tC-vehicleshop:client:TestDriveReturn'
        }
    }
}
        ...
        while inTestDrive do
            if GetGameTimer() < gameTimer + tonumber(1000 * testDriveTime) then
                ...
                if secondsLeft >= tonumber(1000 * testDriveTime) - 20 or GetPedInVehicleSeat(NetToVeh(testDriveVeh), -1) ~= PlayerPedId() then
                    TriggerServerEvent('tC-vehicleshop:server:deleteVehicle', testDriveVeh)
                    testDriveVeh = 0
                    inTestDrive = false
                ...
                while insideShop do
                    ...
                    vehicleMenu = {
                        ...
                        },
                        {
                            ...
                            params = {
                                event = 'tC-vehicleshop:client:TestDrive',
                            }
                        },
                        {
                            ...
                            params = {
                                isServer = true,
                                event = 'tC-vehicleshop:server:buyShowroomVehicle',
                                args = {
                        ...
                        },
                        {
                            ...
                            params = {
                                event = 'tC-vehicleshop:client:vehCategories',
                            }
                        },
                    }
                    Wait(1000)
                ...
                while insideShop and PlayerData.job and PlayerData.job.name == Config.Shops[name]['Job'] do
                    ...
                    vehicleMenu = {
                        ...
                        },
                        {
                            ...
                            params = {
                                event = 'tC-vehicleshop:client:openIdMenu',
                                args = {
...
-- Events
RegisterNetEvent('tC-vehicleshop:client:homeMenu', function()
    exports['et-menu']:openMenu(vehicleMenu)
end)

RegisterNetEvent('tC-vehicleshop:client:showVehOptions', function()
    exports['et-menu']:openMenu(vehicleMenu, true, true)
end)

RegisterNetEvent('tC-vehicleshop:client:TestDrive', function()
    if not inTestDrive and ClosestVehicle ~= 0 then
        ...
        QBCore.Functions.TriggerCallback('QBCore:Server:SpawnVehicle', function(netId)
            ...
            exports['tC-fuel']:SetFuel(veh, 100)
...
RegisterNetEvent('tC-vehicleshop:client:customTestDrive', function(data)
...
RegisterNetEvent('tC-vehicleshop:client:TestDriveReturn', function()
...
RegisterNetEvent('tC-vehicleshop:client:vehCategories', function()
	local catmenu = {}
    local categoryMenu = {
        {
            ...
            params = {
                event = 'tC-vehicleshop:client:homeMenu'
            }
        }
    }
    ...
    for k, v in pairs(catmenu) do
        categoryMenu[#categoryMenu + 1] = {
            ...
            params = {
                event = 'tC-vehicleshop:client:openVehCats',
                args = {
                    catName = k
                }
            }
...
RegisterNetEvent('tC-vehicleshop:client:openVehCats', function(data)
    local vehMenu = {
        {
            header = Lang:t('menus.goback_header'),
            icon = "fa-solid fa-angle-left",
                ...
                for _, shop in pairs(QBCore.Shared.Vehicles[k]["shop"]) do
                    if shop == insideShop then
                        vehMenu[#vehMenu + 1] = {
                            ...
                            params = {
                                isServer = true,
                                event = 'tC-vehicleshop:server:swapVehicle',
                                args = {
                                    toVehicle = v.model,
...
RegisterNetEvent('tC-vehicleshop:client:swapVehicle', function(data)
...
RegisterNetEvent('tC-vehicleshop:client:buyShowroomVehicle', function(vehicle, plate)
    tempShop = insideShop -- temp hacky way of setting the shop because it changes after the callback has returned since you are outside the zone
    QBCore.Functions.TriggerCallback('QBCore:Server:SpawnVehicle', function(netId)
        local veh = NetToVeh(netId)
        exports['tC-fuel']:SetFuel(veh, 100)
...
RegisterNetEvent('tC-vehicleshop:client:openIdMenu', function(data)
    ...
    if dialog then
        ...
        if data.type == 'testDrive' then
            TriggerServerEvent('tC-vehicleshop:server:customTestDrive', data.vehicle, dialog.playerid)
        elseif data.type == 'sellVehicle' then
            TriggerServerEvent('tC-vehicleshop:server:sellShowroomVehicle', data.vehicle, dialog.playerid)
        end
    end
end)
