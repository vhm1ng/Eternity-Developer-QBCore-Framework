...
RegisterNetEvent('tC-radio:use', function()
    toggleRadio(not radioMenu)
end)

RegisterNetEvent('tC-radio:onRadioDrop', function()
...
CreateThread(function()
    ...
    if IsControlPressed(1, keybindControls[OpenRadioBind]) then
        TriggerClientEvent('tC-radio:use')
    end
end)
...
RegisterNetEvent('tC-radio:client:JoinRadioChannel1', function(channel)
    QBCore.Functions.TriggerCallback('tC-radio:radiocheck', function(radio)
        if radio then
            local channel = 1
            exports["pma-voice"]:setRadioChannel(channel)
            if SplitStr(tostring(channel), ".")[2] ~= nil and SplitStr(tostring(channel), ".")[2] ~= "" then
...
RegisterNetEvent('tC-radio:client:JoinRadioChannel2', function(channel)
    QBCore.Functions.TriggerCallback('tC-radio:radiocheck', function(radio)
        if radio then
            local channel = 2
            exports["pma-voice"]:setRadioChannel(channel)
...
RegisterNetEvent('tC-radio:client:JoinRadioChannel3', function(channel)
    QBCore.Functions.TriggerCallback('tC-radio:radiocheck', function(radio)
        if radio then
            local channel = 3
            exports["pma-voice"]:setRadioChannel(channel)
...
RegisterNetEvent('tC-radio:client:JoinRadioChannel4', function(channel)
    QBCore.Functions.TriggerCallback('tC-radio:radiocheck', function(radio)
        if radio then
            local channel = 4
            exports["pma-voice"]:setRadioChannel(channel)
...
RegisterNetEvent('tC-radio:client:JoinRadioChannel5', function(channel)
    QBCore.Functions.TriggerCallback('tC-radio:radiocheck', function(radio)
        if radio then
            local channel = 5
            exports["pma-voice"]:setRadioChannel(channel)
...
RegisterNetEvent('tC-radio:client:JoinRadioChannel6', function(channel)
    QBCore.Functions.TriggerCallback('tC-radio:radiocheck', function(radio)
        if radio then
            local channel = 6
            exports["pma-voice"]:setRadioChannel(channel)
...
RegisterNetEvent('tC-radio:client:JoinRadioChannel7', function(channel)
    QBCore.Functions.TriggerCallback('tC-radio:radiocheck', function(radio)
        if radio then
            local channel = 7
            exports["pma-voice"]:setRadioChannel(channel)
...
RegisterNetEvent('tC-radio:client:JoinRadioChannel8', function(channel)
    QBCore.Functions.TriggerCallback('tC-radio:radiocheck', function(radio)
        if radio then
            local channel = 8
            exports["pma-voice"]:setRadioChannel(channel)
...
RegisterNetEvent('tC-radio:client:JoinRadioChannel9', function(channel)
    QBCore.Functions.TriggerCallback('tC-radio:radiocheck', function(radio)
        if radio then
            local channel = 9
            exports["pma-voice"]:setRadioChannel(channel)
...
RegisterNetEvent('tC-radio:client:JoinRadioChannel10', function(channel)
    QBCore.Functions.TriggerCallback('tC-radio:radiocheck', function(radio)
        if radio then
            local channel = 10
            exports["pma-voice"]:setRadioChannel(channel)
...
RegisterNetEvent('tC-radio:client:JoinRadioChannelToggle', function()
    leaveradio()
end)
