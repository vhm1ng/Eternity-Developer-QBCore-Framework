...
-- This is a workaround solution because the et-menu present in et-policejob fills in an impound location and sends it to the event. 
-- If the impound locations are modified in et-policejob, the changes must also be implemented here to ensure consistency.
