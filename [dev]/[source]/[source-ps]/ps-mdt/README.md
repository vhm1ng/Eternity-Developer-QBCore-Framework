...
- [et-apartments](https://github.com/qbcore-framework/et-apartments) | [Config](https://github.com/Project-Sloth/ps-mdt/blob/0ce2ab88d2ca7b0a49abfb3f7f8939d0769c7b73/shared/config.lua#L3) available to enable or disable. 
- [et-communityservice](https://github.com/Zepherlah/et-community-service) - If you're planning on sending to community service. 
...
* Your citizens can self-register weapons found on their inventory. Event to trigger is below if you're using et-target. There's also a command available named `registerweapon` but you'll need to uncomment if you want to use it.
```
...
* If you're getting kicked for attempted exploit abuse when jailing. Located the follow event below on et-policejob > server > main.lua

```lua
police:server:JailPlayer
```

* Then comment out around line [779](https://github.com/qbcore-framework/et-policejob/blob/937499495aa73538710737c14bd1b26d233dd599/server/main.lua#L779) as seen below
...
* [et-inventory](https://github.com/qbcore-framework/et-inventory) follow instructions below. 
