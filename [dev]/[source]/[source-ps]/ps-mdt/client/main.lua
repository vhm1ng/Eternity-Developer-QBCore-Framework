...
-- Uses the et-Core bill command to send a fine to a player
...
RegisterNUICallback("sendToCommunityService", function(data, cb)
    ...
    if sentence > 0 then
        TriggerServerEvent("et-communityservice:server:StartCommunityService", targetSourceId, sentence)
    end
end)
