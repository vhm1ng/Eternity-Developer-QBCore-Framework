...
Config.MinimumSpeed = 80 -- Going Over This Speed Will Cause Stress
Config.DisablePoliceStress = false -- Default: false, If true will disable stress for people with the police job
Config.FuelScript = 'tC-fuel' -- change to lj-fuel if you use lj-fuel or something else if you use any other LegcyFuel compatible script
