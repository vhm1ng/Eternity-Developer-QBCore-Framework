...
local function hasHarness()
    ...
    local hasHarness = exports['et-smallresources']:HasHarness()
    if hasHarness then
        _harness = true
    else
        _harness = false
...
RegisterNetEvent('hud:client:UpdateNeeds', function(newHunger, newThirst) -- Triggered in et-core
    hunger = newHunger
    thirst = newThirst
end)
...
RegisterNetEvent("et-admin:client:ToggleDevmode", function()
    dev = not dev
end)
...
RegisterNetEvent('hud:client:BuffEffect', function(data)
    ...
    elseif data.display ~= nil then
        ...
        print("et-Hud error: data invalid from client event call: hud:client:BuffEffect")
    end
end)
...
RegisterNetEvent('hud:client:EnhancementEffect', function(data)
    ...
    elseif data.display ~= nil then
        ...
        print("et-Hud error: data invalid from client event call: hud:client:EnhancementEffect")
    end
end)
