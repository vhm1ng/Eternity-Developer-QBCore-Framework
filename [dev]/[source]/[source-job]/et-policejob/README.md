# et-policejob
Police Job for et-Core Framework :police_officer:
...
- [et-bossmenu](https://github.com/qbcore-framework/et-bossmenu)  (Deprecated) - For the boss menu
- [et-management](https://github.com/qbcore-framework/et-management) (Replaces et-bossmenu) - For the boss/gang menu
- [et-garages](https://github.com/qbcore-framework/et-garages) - For the vehicle spawner
- [et-clothing](https://github.com/qbcore-framework/et-clothing) - For the locker room
- [et-phone](https://github.com/qbcore-framework/et-phone) - For the MEOS app and notifications etc.
- [et-log](https://github.com/qbcore-framework/et-logs) - (Deprecated) - For logging certain events
- [et-smallresources](https://github.com/qbcore-framework/et-smallresources) (Replaces et-log) - et-log was added to et-smallresources
- [et-menu](https://github.com/qbcore-framework/et-menu) - For the vehicle menus
- [et-input](https://github.com/qbcore-framework/et-input) - For accessing evidence stashes
