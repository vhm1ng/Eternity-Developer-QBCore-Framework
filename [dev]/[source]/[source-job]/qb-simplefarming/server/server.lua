...
RegisterNetEvent('et-simpefarming:sellItems', function()
    local source = source
    local price = 0
...
RegisterServerEvent('et-simplefarming:applepicking', function()
    local source = source
...
RegisterServerEvent('et-simplefarming:appleprocess', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
QBCore.Functions.CreateCallback('et-simplefarming:apples', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
QBCore.Functions.CreateCallback('et-simplefarming:weapon_knife', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
QBCore.Functions.CreateCallback('et-simplefarming:cowmeat', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
QBCore.Functions.CreateCallback('et-simplefarming:emptycowbucket', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
QBCore.Functions.CreateCallback('et-simplefarming:milkbucketfull', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
RegisterServerEvent('et-simplefarming:cowmilking', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('et-simplefarming:cowkilling', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('et-simplefarming:beefprocess', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('et-simplefarming:getcowbucket', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('et-simplefarming:dairymilk', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('et-simplefarming:pumpkinpicking', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('et-simplefarming:pumpkinprocessing', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
QBCore.Functions.CreateCallback('et-simplefarming:pumpkincheck', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
QBCore.Functions.CreateCallback('et-simplefarming:corncheck', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
RegisterServerEvent('et-simplefarming:cornpicking', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('et-simplefarming:cornprocessing', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
QBCore.Functions.CreateCallback('et-simplefarming:grapecheck', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
QBCore.Functions.CreateCallback('et-simplefarming:greenpeppercheck', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
QBCore.Functions.CreateCallback('et-simplefarming:chillycheck', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
QBCore.Functions.CreateCallback('et-simplefarming:tomatoescheck', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
RegisterServerEvent('et-simplefarming:grapepicking', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('et-simplefarming:grapeprocessing', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('et-simplefarming:gpepperpicking', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('et-simplefarming:chypepperpicking', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('et-simplefarming:makinghotsauce', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('et-simplefarming:tomatoespicking', function()
    local Player = QBCore.Functions.GetPlayer(source)
...
RegisterServerEvent('et-simplefarming:tomatoesprocessing', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
QBCore.Functions.CreateCallback('et-simplefarming:soybeancheck', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
QBCore.Functions.CreateCallback('et-simplefarming:rawbacon', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
QBCore.Functions.CreateCallback('et-simplefarming:rawham', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
QBCore.Functions.CreateCallback('et-simplefarming:rawpork', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
QBCore.Functions.CreateCallback('et-simplefarming:rawsausage', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
RegisterServerEvent('et-simplefarming:baconprocessed', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('et-simplefarming:hamprocessed', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('et-simplefarming:porkprocessed', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('et-simplefarming:sausageprocessed', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('et-simplefarming:pigfood', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('et-simplefarming:feedingpiglit', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
    ...
    TriggerClientEvent('et-simplefarming:relievestress', source)
end)

RegisterNetEvent('et-simplefarming:slayreward', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
