...
function createPeds()
    ...
    QBCore.Functions.TriggerCallback('vhming-multicharacter:server:get', function(chars, max)
        if #chars > 0 and chars[1] then
            QBCore.Functions.TriggerCallback('vhming-multicharacter:server:getSkin', function(data)
...
RegisterNUICallback("create", function(data, cb)
    QBCore.Functions.TriggerCallback('vhming-multicharacter:server:createCharacter', function(res)
        cb(res)
...
RegisterNUICallback("select", function(data, cb)
    ...
    TriggerServerEvent('vhming-multicharacter:server:spawnPlayer', data.citizenid)
end)

RegisterNUICallback("delete", function(data, cb)
    QBCore.Functions.TriggerCallback('vhming-multicharacter:server:deleteCharacter', function(chars, max)
        DeletePed(CreatedPeds['default'])
        CreatedPeds = {}
        PlayerCharacters = {}
        currentChar = nil
