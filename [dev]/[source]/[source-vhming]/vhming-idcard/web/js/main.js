 ...
 **/
const setVisibility = (visibility) => getElementById('vhming-idcard').style.visibility = visibility;
...
const closeFunction = () => {
  getElementById('vhming-idcard').classList.remove('animate__animated', 'animate__fadeInLeft', 'animate__faster');
...
const openIdCard = (playerData) => {
  ...
  getElementById('vhming-idcard').style.backgroundColor = license.background;
  getElementById('vhming-idcard').classList.add('animate__animated', 'animate__fadeInLeft', 'animate__faster');
