...
Config.FuelTargetExport = false -- DO NOT USE WITH OX_TARGET! This is only used to fix this et-target issue: https://github.com/CodineDev/cdn-fuel/issues/3. <br> <br> If you don't have this issue and haven't installed this exports in et-target, then this should be false. Otherwise there will be an error.
...
Config.Core = 'et-core' -- Change this to your core resources (Ex: 'qbx-core' | 'et-core'), must be qb based!
Config.Ox = {
    Inventory = false, -- Uses OX_Inventory's metadata instead of QB-Inventory's.
    Menu = false, -- Uses OX Libraries instead of et-menu.
    Input = false, -- Uses Ox Input Dialog instead of et-input.
    DrawText = false, -- Uses Ox DrawText instead of et-core DrawText.
    Progress = false -- Uses Ox ProgressBar instead of progressbar.
}
Config.TargetResource = "et-target" -- Supported: { 'et-target', 'ox_target'} -- Others must use the same format as QB-Target or manual configuration is required.
...
Config.SyphonDispatchSystem = "ps-dispatch" -- Options: "ps-dispatch", "et-dispatch", "et-default" (just blips) or "custom" (Custom: you must configure yourself!)
