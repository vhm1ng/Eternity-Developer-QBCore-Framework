        ...
        while isProspecting do
            ...
            if canProspect then
                ...
                if index then
                    ...
                    if dist < 3.0 then 
                        ShowHelps = true
                        -- exports['et-core']:DrawText('[Nhấn Chuột] để đào', 'left')
                        ShowFloatingHelp("[Nhấn Chuột] để đào", pos)
                ...
                if not scannerAudio then
                    exports['et-core']:DrawText('[R] Bật Tiếng, [F] Dừng Dò', 'left')
                else
                    exports['et-core']:DrawText('[R] Tắt Tiếng, [F] Dừng Dò', 'left')
                end
