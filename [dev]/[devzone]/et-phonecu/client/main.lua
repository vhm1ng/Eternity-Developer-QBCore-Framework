...
exports["et-target"]:AddTargetModel(PublicPhoneobject, {
    options = {
        {
            type = "client",
            event = "et-phone:client:publocphoneopen",
...
RegisterNUICallback('AddNewContact', function(data, cb)
    ...
    TriggerServerEvent('et-phone:server:AddNewContact', data.ContactName, data.ContactNumber)
end)
...
RegisterNUICallback('EditContact', function(data, cb)
    ...
    Wait(100)
    cb(PhoneData.Contacts)
    TriggerServerEvent('et-phone:server:EditContact', NewName, NewNumber, OldName, OldNumber)
end)
...
RegisterNUICallback('CallContact', function(data, cb)
    QBCore.Functions.TriggerCallback('et-phone:server:GetCallState', function(CanCall, IsOnline)
        local status = {
            CanCall = CanCall,
            IsOnline = IsOnline,
...
RegisterNetEvent('et-phone:client:clearAppAlerts', function()
    Config.PhoneApplications["phone"].Alerts = 0
    SendNUIMessage({ action = "RefreshAppAlerts", AppData = Config.PhoneApplications })
end)
...
RegisterNetEvent('et-phone:client:publocphoneopen',function()
    SetNuiFocus(true, true)
...
RegisterNetEvent("et-phone:client:giveContactRequest", function(contactInfo)
    local success = exports['et-phone']:PhoneNotification("CONTACT REQUEST", contactInfo.name..' contact request', 'fas fa-phone', '#b3e0f2', "NONE", 'fas fa-check-circle', 'fas fa-times-circle')
    if success then
        TriggerServerEvent('et-phone:server:acceptContactRequest', contactInfo)
    end
end)

RegisterNetEvent('et-phone:client:updateContactInfo', function(contactInfo)
    PhoneData.Contacts[#PhoneData.Contacts+1] = {
