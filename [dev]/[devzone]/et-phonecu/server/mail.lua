...
RegisterNetEvent('et-phone:server:sendNewMail', function(mailData, citizenID)
    ...
    if Player then
        ...
        TriggerClientEvent('et-phone:client:NewMailNotify', Player.PlayerData.source, mailData)
