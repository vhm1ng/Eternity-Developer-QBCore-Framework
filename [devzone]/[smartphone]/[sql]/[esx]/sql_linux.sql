ALTER TABLE `users` ADD `apps` TEXT;
ALTER TABLE `users` ADD `widget` TEXT;
ALTER TABLE `users` ADD `bt` TEXT;
ALTER TABLE `users` ADD `charinfo` text;
ALTER TABLE `users` ADD `metadata` mediumtext;
ALTER TABLE `users` ADD `cryptocurrency` longtext;
ALTER TABLE `users` ADD `cryptocurrencytransfers` TEXT;
