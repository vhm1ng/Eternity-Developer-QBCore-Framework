      ...
      ApplePicking:onPlayerInOut(function(isPointInside)
        if isPointInside then
          ...
          for _, v in pairs(ATreeZones) do
            exports['et-target']:RemoveZone(v.Name)
            inZone = false
          end
        end
      end)
...
RegisterNetEvent('et-simplefarming:processapples', function()
  QBCore.Functions.TriggerCallback('et-simplefarming:apples', function(apples)
    if apples then
      ...
      TriggerEvent('animations:client:EmoteCommandStart', {"c"})
        TriggerServerEvent("et-simplefarming:appleprocess")
      end, function()
...
RegisterNetEvent('et-simplefarming:appletree', function()
  QBCore.Functions.Progressbar('apple_pickingapples', Config.Alerts['apple_pickingbar'], 7500, false, true, {
    ...
    flags = 16,
        ...
        TriggerServerEvent('et-simplefarming:applepicking')
    end, function()
    QBCore.Functions.Notify(Config.Alerts['cancel'], "error")
  end)
end)
...
RegisterNetEvent('AppleTrees', function()
  for _, v in pairs(ATreeZones) do
    exports['et-target']:AddBoxZone(v.Name, vector3(v.Coords.x, v.Coords.y, v.Coords.z), 1, 1, {
      name=v.Name,
      heading= v.heading,
      debugPoly=false,
      minZ = v.minZ,
      ...
      options = {
        {
          type = "client",
          event = "et-simplefarming:appletree",
...
RegisterNetEvent('et-simplefarming:beefprocessing', function()
  QBCore.Functions.TriggerCallback('et-simplefarming:cowmeat', function(rawbeef)
    if rawbeef then
      ...
      disableCombat = true,
          ...
          TriggerEvent('animations:client:EmoteCommandStart', {"c"})
          TriggerServerEvent("et-simplefarming:beefprocess")
      end, function()
        QBCore.Functions.Notify(Config.Alerts['cancel'], "error")
      end)
...
RegisterNetEvent('et-simplefarming:dairyprocessor', function()
  QBCore.Functions.TriggerCallback('et-simplefarming:milkbucketfull', function(milkbucket)
    if milkbucket then
      TriggerEvent('animations:client:EmoteCommandStart', {"Clipboard"})
      ...
      disableCombat = true,
        ...
        TriggerEvent('animations:client:EmoteCommandStart', {"c"})
        TriggerServerEvent("et-simplefarming:dairymilk")
    end, function()
      QBCore.Functions.Notify(Config.Alerts['cancel'], "error")
    end)
...
RegisterNetEvent('et-simplefarming:milkcow', function()
  QBCore.Functions.TriggerCallback('et-simplefarming:emptycowbucket', function(emptybucket)
    if emptybucket then
      ...
      disableCombat = true,
        ...
        TriggerServerEvent("et-simplefarming:cowmilking")
    end, function()
      QBCore.Functions.Notify(Config.Alerts['cancel'], "error")
    end)
...
RegisterNetEvent('et-getcowbucket', function()
  ...
  TriggerServerEvent('et-simplefarming:getcowbucket')
end)

RegisterNetEvent('AnimalFarming', function()
  for _, v in pairs(CowFarming1) do
    exports['et-target']:AddBoxZone(v.Name, vector3(v.Coords.x, v.Coords.y, v.Coords.z), v.length, v.width, {
      name=v.Name,
      heading= v.heading,
      debugPoly=false,
      minZ = v.minZ,
      ...
      options = {
        {
          type = "client",
          event = "et-simplefarming:milkcow",
          icon = "fa fa-tint",
          label = "Milk Cow",
        },
        {
          type = "client",
          event = "et-simplefarming:slaughter1",
          icon = "fa fa-cutlery",
          label = "Kill Cow",
        },
      },
  ...
  for _, v in pairs(CowFarming2) do
    exports['et-target']:AddBoxZone(v.Name, vector3(v.Coords.x, v.Coords.y, v.Coords.z), v.length, v.width, {
      ...
      options = {
        ...
        {
          type = "client",
          event = "et-simplefarming:slaughter2",
          icon = "fa fa-cutlery",
          label = "Kill Cow",
        },
      },
  ...
  for _, v in pairs(CowFarming3) do
    exports['et-target']:AddBoxZone(v.Name, vector3(v.Coords.x, v.Coords.y, v.Coords.z), v.length, v.width, {
      ...
      options = {
        ...
        {
          type = "client",
          event = "et-simplefarming:slaughter3",
          icon = "fa fa-cutlery",
          label = "Kill Cow",
        },
      },
  ...
  for _, v in pairs(CowFarming4) do
    exports['et-target']:AddBoxZone(v.Name, vector3(v.Coords.x, v.Coords.y, v.Coords.z), v.length, v.width, {
      ...
      options = {
        ...
        {
          type = "client",
          event = "et-simplefarming:slaughter4",
          icon = "fa fa-cutlery",
          label = "Kill Cow",
        },
      },
...
exports['et-target']:AddBoxZone("GetCowBucket", vector3(419.13, 6470.74, 28.82), 1.4, 0.5, {
  name = "GetCowBucket",
  heading=315,
  debugPoly = false,
  minZ=24.37,
  ...
  CreateThread(function()
    for k in pairs(PumpkinField) do
      ...
      PumpkinFarmingLocation:onPlayerInOut(function(isPointInside)
        if isPointInside then
          inZone = true
          TriggerEvent('et-simplefarming:pumpkin')
        else
...
RegisterNetEvent('et-simplefarming:pumpkinfarming', function()
  local playerPed = PlayerPedId()
  ...
  QBCore.Functions.Progressbar("picking_pumpkins", Config.Alerts['picking_pumpkins'], 3000, false, true, {
      ...
      TriggerServerEvent('et-simplefarming:pumpkinpicking')
  end, function()
      ClearPedTasks(PlayerPedId())
      QBCore.Functions.Notify(Config.Alerts['cancel'], "error")
  end)
...
RegisterNetEvent('et-simplefarming:pumpkinpie', function()
  QBCore.Functions.TriggerCallback('et-simplefarming:pumpkincheck', function(pumpkin)
    if pumpkin then
      TriggerEvent('animations:client:EmoteCommandStart', {"Clipboard"})
      ...
      disableCombat = true,
        ...
        TriggerEvent('animations:client:EmoteCommandStart', {"c"})
        TriggerServerEvent("et-simplefarming:pumpkinprocessing")
      end, function()
      QBCore.Functions.Notify(Config.Alerts['cancel'], "error")
      end)
...
RegisterNetEvent('et-simplefarming:pumpkin', function()
  for _, v in pairs(PumpkinFarming1) do
    exports['et-target']:AddBoxZone(v.Name, vector3(v.Coords.x, v.Coords.y, v.Coords.z), v.length, v.width, {
      name=v.Name,
      heading= v.heading,
      ...
      options = {
        {
          type = "client",
          event = "et-simplefarming:pumpkinfarming",
...
RegisterNetEvent('et-simplefarming:cornfield', function()
  QBCore.Functions.Progressbar("picking_corns", Config.Alerts['corn_picking'], 3000, false, true, {
      ...
      flags = 16,
        ...
        TriggerServerEvent('et-simplefarming:cornpicking')
    end, function()
    ClearPedTasks(PlayerPedId())
    QBCore.Functions.Notify(Config.Alerts['cancel'], "error")
  end)
...
RegisterNetEvent('et-simplefarming:makecancorn', function()
  QBCore.Functions.TriggerCallback('et-simplefarming:corncheck', function(corncob)
    if corncob then
      TriggerEvent('animations:client:EmoteCommandStart', {"Clipboard"})
      ...
      disableCombat = true,
          ...
          TriggerEvent('animations:client:EmoteCommandStart', {"c"})
          TriggerServerEvent("et-simplefarming:cornprocessing")
      end, function()
        QBCore.Functions.Notify(Config.Alerts['cancel'], "error")
      end)
  ...
  for _, v in pairs(CornField1) do
    exports['et-target']:AddBoxZone(v.Name, vector3(v.Coords.x, v.Coords.y, v.Coords.z), v.length, v.width, {
      ...
      options = {
        {
          type = "client",
          event = "et-simplefarming:cornfield",
          icon = "fa fa-sign-language",
          label = "Gather Corn",
        },
      },
...
RegisterNetEvent('et-simplefarming:grapefield', function()
  ...
  QBCore.Functions.Progressbar("grapefield_picking", Config.Alerts['grape_picking'], 3000, false, true, {
    ...
    TriggerEvent('animations:client:EmoteCommandStart', {"C"})
    TriggerServerEvent('et-simplefarming:grapepicking')
  end, function()
    ClearPedTasks(PlayerPedId())
    QBCore.Functions.Notify(Config.Alerts['cancel'], "error")
  end)
...
RegisterNetEvent('et-simplefarming:greenpepperfield', function()
  TriggerEvent('animations:client:EmoteCommandStart', {"Mechanic4"})
  QBCore.Functions.Progressbar("greenpepper_picking", Config.Alerts['greenpepper_picking'], 3000, false, true, {
    ...
    TriggerEvent('animations:client:EmoteCommandStart', {"C"})
    TriggerServerEvent('et-simplefarming:gpepperpicking')
  end, function()
    ClearPedTasks(PlayerPedId())
    QBCore.Functions.Notify(Config.Alerts['cancel'], "error")
  end)
...
RegisterNetEvent('et-simplefarming:chillfield', function()
  TriggerEvent('animations:client:EmoteCommandStart', {"Mechanic4"})
  QBCore.Functions.Progressbar("chilly_picking", Config.Alerts['chillypepper_picking'], 3000, false, true, {
    ...
    TriggerEvent('animations:client:EmoteCommandStart', {"C"})
    TriggerServerEvent('et-simplefarming:chypepperpicking')
  end, function()
    ClearPedTasks(PlayerPedId())
    QBCore.Functions.Notify(Config.Alerts['cancel'], "error")
  end)
...
RegisterNetEvent('et-simplefarming:tomatoefields', function()
  TriggerEvent('animations:client:EmoteCommandStart', {"Mechanic4"})
  QBCore.Functions.Progressbar("tomatoes_picking", Config.Alerts['tomatoes_picking'], 3000, false, true, {
    ...
    TriggerEvent('animations:client:EmoteCommandStart', {"C"})
    TriggerServerEvent('et-simplefarming:tomatoespicking')
  end, function()
    ClearPedTasks(PlayerPedId())
    QBCore.Functions.Notify(Config.Alerts['cancel'], "error")
  end)
...
RegisterNetEvent('et-simplefarming:makingragu', function()
  QBCore.Functions.TriggerCallback('et-simplefarming:tomatoescheck', function(tomatoes)
    if tomatoes then
      TriggerEvent('animations:client:EmoteCommandStart', {"Clipboard"})
      ...
      disableCombat = true,
          ...
          TriggerEvent('animations:client:EmoteCommandStart', {"c"})
          TriggerServerEvent("et-simplefarming:tomatoesprocessing")
      end, function()
        QBCore.Functions.Notify(Config.Alerts['cancel'], "error")
      end)
...
RegisterNetEvent('et-simplefarming:makingchillysauce', function()
  QBCore.Functions.TriggerCallback('et-simplefarming:chillycheck', function(hotstuff)
    if hotstuff then
      TriggerEvent('animations:client:EmoteCommandStart', {"Clipboard"})
      ...
      disableCombat = true,
          ...
          TriggerEvent('animations:client:EmoteCommandStart', {"c"})
          TriggerServerEvent("et-simplefarming:makinghotsauce")
      end, function()
        QBCore.Functions.Notify(Config.Alerts['cancel'], "error")
      end)
...
RegisterNetEvent('et-simplefarming:makinggrapejuice', function()
  QBCore.Functions.TriggerCallback('et-simplefarming:grapecheck', function(grapes)
    if grapes then
      TriggerEvent('animations:client:EmoteCommandStart', {"Clipboard"})
      ...
      disableCombat = true,
          ...
          TriggerEvent('animations:client:EmoteCommandStart', {"c"})
          TriggerServerEvent("et-simplefarming:grapeprocessing")
      end, function()
        QBCore.Functions.Notify(Config.Alerts['cancel'], "error")
      end)
  ...
  for _, v in pairs(GrapeFields) do
    exports['et-target']:AddBoxZone(v.Name, vector3(v.Coords.x, v.Coords.y, v.Coords.z), v.length, v.width, {
      ...
      options = {
          {
            type = "client",
            event = "et-simplefarming:grapefield",
            icon = "fa fa-sign-language",
  ...
  for _, v in pairs(GPeppersFields) do
    exports['et-target']:AddBoxZone(v.Name, vector3(v.Coords.x, v.Coords.y, v.Coords.z), v.length, v.width, {
      ...
      options = {
          {
            type = "client",
            event = "et-simplefarming:greenpepperfield",
            icon = "fa fa-sign-language",
            label = "Pick From Garden",
          },
        },
  ...
  for _, v in pairs(CPeppersFields) do
    exports['et-target']:AddBoxZone(v.Name, vector3(v.Coords.x, v.Coords.y, v.Coords.z), v.length, v.width, {
      ...
      options = {
          {
            type = "client",
            event = "et-simplefarming:chillfield",
            icon = "fa fa-sign-language",
            label = "Pick From Garden",
          },
        },
  ...
  for _, v in pairs(TomatoesField) do
    exports['et-target']:AddBoxZone(v.Name, vector3(v.Coords.x, v.Coords.y, v.Coords.z), v.length, v.width, {
      ...
      options = {
          {
            type = "client",
            event = "et-simplefarming:tomatoefields",
            icon = "fa fa-sign-language",
            label = "Pick From Garden",
          },
        },
...
RegisterNetEvent('et-simplefarming:petpiggy', function()
...
RegisterNetEvent('et-simplefarming:feedpig', function ()
  QBCore.Functions.TriggerCallback('et-simplefarming:soybeancheck', function(soybeans)
    if soybeans then
      ...
      QBCore.Functions.Progressbar("feeding_pig", "Feeding Pig", 5000, false, true, { -- 5 Seconds
          ...
          TriggerEvent('animations:client:EmoteCommandStart', {"c"})
          TriggerServerEvent("et-simplefarming:feedingpiglit")
          Wait(2000)
      end, function()
          ClearPedTasks(PlayerPedId())
          QBCore.Functions.Notify(Config.Alerts['cancel'], "error")
...
RegisterNetEvent('et-simplefarming:relievestress', function ()
  TriggerServerEvent('hud:server:RelieveStress', math.random(2, 5))
end)

RegisterNetEvent('et-simplefarming:baconprocessing', function()
  QBCore.Functions.TriggerCallback('et-simplefarming:rawbacon', function(rawbeef)
    if rawbeef then
      TriggerEvent('animations:client:EmoteCommandStart', {"BBQ"})
      ...
      disableCombat = true,
          ...
          TriggerEvent('animations:client:EmoteCommandStart', {"c"})
          TriggerServerEvent("et-simplefarming:baconprocessed")
      end, function()
        QBCore.Functions.Notify(Config.Alerts['cancel'], "error")
      end)
    elseif not rawbeef then
...
RegisterNetEvent('et-simplefarming:hamprocessing', function()
  QBCore.Functions.TriggerCallback('et-simplefarming:rawham', function(rawbeef)
    if rawbeef then
      TriggerEvent('animations:client:EmoteCommandStart', {"BBQ"})
      ...
      disableMouse = false,
        disableCombat = true,
          ...
          TriggerEvent('animations:client:EmoteCommandStart', {"c"})
          TriggerServerEvent("et-simplefarming:hamprocessed")
      end, function()
        QBCore.Functions.Notify(Config.Alerts['cancel'], "error")
      end)
    elseif not rawbeef then
...
RegisterNetEvent('et-simplefarming:porkprocessing', function()
  QBCore.Functions.TriggerCallback('et-simplefarming:rawpork', function(rawbeef)
    if rawbeef then
      TriggerEvent('animations:client:EmoteCommandStart', {"BBQ"})
      ...
      disableCombat = true,
          ...
          TriggerEvent('animations:client:EmoteCommandStart', {"c"})
          TriggerServerEvent("et-simplefarming:porkprocessed")
      end, function()
        QBCore.Functions.Notify(Config.Alerts['cancel'], "error")
      end)
    elseif not rawbeef then
...
RegisterNetEvent('et-simplefarming:sausageprocessing', function()
  QBCore.Functions.TriggerCallback('et-simplefarming:rawpork', function(rawbeef)
    if rawbeef then
      TriggerEvent('animations:client:EmoteCommandStart', {"BBQ"})
      ...
      disableCombat = true,
          ...
          TriggerEvent('animations:client:EmoteCommandStart', {"c"})
          TriggerServerEvent("et-simplefarming:sausageprocessed")
      end, function()
        QBCore.Functions.Notify(Config.Alerts['cancel'], "error")
      end)
    elseif not rawbeef then
  ...
  for _, v in pairs(PigPens1) do
    exports['et-target']:AddBoxZone(v.Name, vector3(v.Coords.x, v.Coords.y, v.Coords.z), v.length, v.width, {
      ...
      options = {
        {
          type = "client",
          event = "et-simplefarming:petpiggy",
          icon = "Fas Fa-Hand-Paper",
          label = "Pet",
        },
        {
          type = "client",
          event = "et-simplefarming:feedpig",
          icon = "Fas Fa-Hand-Holding-Heart",
          label = "Feed Pig",
        },
        {
          type = "client",
          event = "et-simplefarming:killpig1",
  ...
  for _, v in pairs(PigPens2) do
    exports['et-target']:AddBoxZone(v.Name, vector3(v.Coords.x, v.Coords.y, v.Coords.z), v.length, v.width, {
      ...
      options = {
        ...
        {
          type = "client",
          event = "et-simplefarming:killpig2",
          icon = "Fas Fa-Piggy-Bank",
          label = "Slaughter Pig",
        },
      },
  ...
  for _, v in pairs(PigPens3) do
    exports['et-target']:AddBoxZone(v.Name, vector3(v.Coords.x, v.Coords.y, v.Coords.z), v.length, v.width, {
      ...
      options = {
        ...
        {
          type = "client",
          event = "et-simplefarming:killpig3",
          icon = "Fas Fa-Piggy-Bank",
          label = "Slaughter Pig",
        },
      },
  ...
  for _, v in pairs(PigPens4) do
    exports['et-target']:AddBoxZone(v.Name, vector3(v.Coords.x, v.Coords.y, v.Coords.z), v.length, v.width, {
      ...
      options = {
        ...
        {
          type = "client",
          event = "et-simplefarming:killpig4",
          icon = "Fas Fa-Piggy-Bank",
          label = "Slaughter Pig",
        },
      },
  ...
  for _, v in pairs(PigPens5) do
    exports['et-target']:AddBoxZone(v.Name, vector3(v.Coords.x, v.Coords.y, v.Coords.z), v.length, v.width, {
      ...
      options = {
        ...
        {
          type = "client",
          event = "et-simplefarming:killpig5",
          icon = "Fas Fa-Piggy-Bank",
          label = "Slaughter Pig",
        },
      },
  ...
  for _, v in pairs(PigPens6) do
    exports['et-target']:AddBoxZone(v.Name, vector3(v.Coords.x, v.Coords.y, v.Coords.z), v.length, v.width, {
      ...
      options = {
        ...
        {
          type = "client",
          event = "et-simplefarming:killpig6",
          icon = "Fas Fa-Piggy-Bank",
          label = "Slaughter Pig",
        },
      },
  ...
  for _, v in pairs(PigPens7) do
    exports['et-target']:AddBoxZone(v.Name, vector3(v.Coords.x, v.Coords.y, v.Coords.z), v.length, v.width, {
      ...
      options = {
        ...
        {
          type = "client",
          event = "et-simplefarming:killpig7",
          icon = "Fas Fa-Piggy-Bank",
          label = "Slaughter Pig",
        },
      },
  ...
  for _, v in pairs(PigPens8) do
    exports['et-target']:AddBoxZone(v.Name, vector3(v.Coords.x, v.Coords.y, v.Coords.z), v.length, v.width, {
      ...
      options = {
        ...
        {
          type = "client",
          event = "et-simplefarming:killpig8",
          icon = "Fas Fa-Piggy-Bank",
          label = "Slaughter Pig",
        },
      },
  ...
  for _, v in pairs(PigPens9) do
    exports['et-target']:AddBoxZone(v.Name, vector3(v.Coords.x, v.Coords.y, v.Coords.z), v.length, v.width, {
      ...
      options = {
        ...
        {
          type = "client",
          event = "et-simplefarming:killpig9",
          icon = "Fas Fa-Piggy-Bank",
          label = "Slaughter Pig",
        },
      },
  ...
  for _, v in pairs(PigPens10) do
    exports['et-target']:AddBoxZone(v.Name, vector3(v.Coords.x, v.Coords.y, v.Coords.z), v.length, v.width, {
      ...
      options = {
        ...
        {
          type = "client",
          event = "et-simplefarming:killpig10",
          icon = "Fas Fa-Piggy-Bank",
          label = "Slaughter Pig",
        },
      },
  ...
  for _, v in pairs(PigPens11) do
    exports['et-target']:AddBoxZone(v.Name, vector3(v.Coords.x, v.Coords.y, v.Coords.z), v.length, v.width, {
      ...
      options = {
        ...
        {
          type = "client",
          event = "et-simplefarming:killpig11",
          icon = "Fas Fa-Piggy-Bank",
          label = "Slaughter Pig",
        },
      },
  ...
  for _, v in pairs(PigPens12) do
    exports['et-target']:AddBoxZone(v.Name, vector3(v.Coords.x, v.Coords.y, v.Coords.z), v.length, v.width, {
      ...
      options = {
        ...
        {
          type = "client",
          event = "et-simplefarming:killpig12",
          icon = "Fas Fa-Piggy-Bank",
          label = "Slaughter Pig",
        },
      },
  ...
  for _, v in pairs(PigPens13) do
    exports['et-target']:AddBoxZone(v.Name, vector3(v.Coords.x, v.Coords.y, v.Coords.z), v.length, v.width, {
      ...
      options = {
        ...
        {
          type = "client",
          event = "et-simplefarming:killpig13",
          icon = "Fas Fa-Piggy-Bank",
          label = "Slaughter Pig",
        },
      },
  ...
  for _, v in pairs(PigPens14) do
    exports['et-target']:AddBoxZone(v.Name, vector3(v.Coords.x, v.Coords.y, v.Coords.z), v.length, v.width, {
      ...
      options = {
        ...
        {
          type = "client",
          event = "et-simplefarming:killpig14",
          icon = "Fas Fa-Piggy-Bank",
          label = "Slaughter Pig",
        },
      },
  ...
  for _, v in pairs(PigPens15) do
    exports['et-target']:AddBoxZone(v.Name, vector3(v.Coords.x, v.Coords.y, v.Coords.z), v.length, v.width, {
      ...
      options = {
        ...
        {
          type = "client",
          event = "et-simplefarming:killpig15",
          icon = "Fas Fa-Piggy-Bank",
          label = "Slaughter Pig",
        },
      },
  ...
  for _, v in pairs(PigPens16) do
    exports['et-target']:AddBoxZone(v.Name, vector3(v.Coords.x, v.Coords.y, v.Coords.z), v.length, v.width, {
      ...
      options = {
        ...
        {
          type = "client",
          event = "et-simplefarming:killpig16",
          icon = "Fas Fa-Piggy-Bank",
          label = "Slaughter Pig",
        },
      },
...
exports['et-target']:AddBoxZone("dairyfarmer", DairyProcessor.targetZone, 1, 1, {
	name = "dairyfarmer",
    ...
    {
      type = "client",
      event = "et-simplefarming:dairyprocessor",
...
exports['et-target']:AddBoxZone("piggyfarmer", PigFarmerTargetZone, 0.6, 0.8, {
	name = "piggyfarmer",
    ...
    {
      type = "server",
      event = "et-simplefarming:pigfood",
      icon = "Fas Fa-Bacon",
      label = "Grab Pig Food",
    },
	},
...
RegisterNetEvent('et-simplefarming:menuprocessor', function()
  local Processor = {
    {
    ...
    },
    {
        ...
        params = {
            event = 'et-simplefarming:processapples',
        }
    },
    {
        header = 'Make Pumpkin Pies',
        params = {
            event = 'et-simplefarming:pumpkinpie',
        }
    },
    {
        header = 'Make Grape Juice',
        params = {
            event = 'et-simplefarming:makinggrapejuice',
        }
    },
    {
        header = 'Make Caned Corn',
        params = {
            event = 'et-simplefarming:makecancorn',
        }
    },
    {
        header = 'Make HotSauce',
        params = {
            event = 'et-simplefarming:makingchillysauce',
        }
    },
    {
        header = 'Make TomatoPaste',
        params = {
            event = 'et-simplefarming:makingragu',
        }
    },
}
...
RegisterNetEvent('et-simplefarming:menufcow', function()
  local MeatCooking = {
    {
      header = "Cooking Food",
      isMenuHeader = true,
    ...
    },
    {
        header = 'Cook Beef',
        params = {
            event = 'et-simplefarming:beefprocessing',
        }
    },
    {
        header = 'Cook Ham',
        params = {
            event = 'et-simplefarming:hamprocessing',
        }
    },
    {
        header = 'Cook Bacon',
        params = {
            event = 'et-simplefarming:baconprocessing',
        }
    },
    {
        header = 'Cook Pork',
        params = {
            event = 'et-simplefarming:porkprocessing',
        }
    },
    {
        header = 'Cook Sausage',
        params = {
            event = 'et-simplefarming:sausageprocessing',
        }
    },
}
exports['et-menu']:openMenu(MeatCooking)
end)


exports['et-target']:AddBoxZone("grammahouse", vector3(2438.07, 4975.82, 46.81), 1.0, 1.0, {
	name = "grammahouse",
	heading = 315,
	debugPoly = false,
  minZ = 46.76,
  maxZ = 47.16,
    ...
    {
      type = "client",
      event = "et-simplefarming:menufcow",
      icon = "Fas Fa-hands",
      label = "Start Cooking",
    },
	},
...
exports['et-target']:AddBoxZone("processingped", FoodProcessor.targetZone, 1, 1, {
    ...
    {
      type = "client",
      event = "et-simplefarming:menuprocessor",
      icon = "Fas Fa-hands",
...
exports['et-target']:AddBoxZone("sellerped", Seller.targetZone, 1, 1, {
	name = "seller",
    ...
    {
      type = "server",
      event = "et-simpefarming:sellItems",
      icon = "Fas Fa-hands",
      label = "Talk to farmer",
    },
	},
