...
local function loadHouseData(src)
    ...
    TriggerClientEvent("et-garages:client:houseGarageConfig", src, HouseGarages)
    TriggerClientEvent("et-houses:client:setHouseConfig", src, Houses)
end
...
QBCore.Functions.CreateCallback("vhming-multicharacter:server:getSkin", function(_, cb, cid)
