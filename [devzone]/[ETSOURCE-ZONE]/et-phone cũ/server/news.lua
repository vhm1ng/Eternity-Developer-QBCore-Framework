...
RegisterNetEvent('et-phone:server:Send_lsbn_ToChat', function(data)
    ...
    TriggerClientEvent('et-phone:LSBN-reafy-for-add', -1, Tables, true, data.Text)
end)

RegisterNetEvent('et-phone:server:GetLSBNchats', function()
    local src = source
    TriggerClientEvent('et-phone:LSBN-reafy-for-add', src, LSBNTable, false, nil)
end)