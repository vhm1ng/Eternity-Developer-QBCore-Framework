...
QBCore.Functions.CreateCallback('et-phone:server:GetCallState', function(source, cb, ContactData)
...
QBCore.Functions.CreateCallback('et-phone:server:FetchResult', function(_, cb, input)
...
RegisterNetEvent('et-phone:server:EditContact', function(newName, newNumber, oldName, oldNumber)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('et-phone:server:AddNewContact', function(name, number)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('et-phone:server:AddRecentCall', function(type, data)
    ...
    TriggerClientEvent('et-phone:client:AddRecentCall', Target.PlayerData.source, {
...
RegisterNetEvent('et-phone:server:GiveContactDetails', function(PlayerId)
    ...
    TriggerClientEvent('et-phone:client:giveContactRequest', PlayerId, contactInfo)
end)

RegisterNetEvent('et-phone:server:acceptContactRequest', function(contactInfo)
    ...
    TriggerClientEvent('et-phone:client:updateContactInfo', src, contactInfo)
end)
